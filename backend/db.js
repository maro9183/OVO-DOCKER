...
const TABLES = [
  ...
  `INSERT IGNORE INTO responsables (id_resp, nombre, correo, rol, equipo) VALUES
  ...
  `INSERT IGNORE INTO tareas (id_tarea, id_proyecto, tarea, descripcion, fecha_inicio, fecha_inicio_proyectada, duracion_dias, fecha_fin, estado, responsable, avance, dependencias, costo_tarea, recursos, fecha_creacion) VALUES
