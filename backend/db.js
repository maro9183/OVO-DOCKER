...
const TABLES = [
  ...
  `CREATE TABLE IF NOT EXISTS tareas (
    ...
    estado_compra           VARCHAR(50) DEFAULT 'solicitada',
    dias_arribo             INT DEFAULT 0,
    f_solicitud             DATE DEFAULT NULL,
    f_presupuesto_solic     DATE DEFAULT NULL,
    f_presupuesto_recib     DATE DEFAULT NULL,
    f_oc                    DATE DEFAULT NULL,
    f_comprometida          DATE DEFAULT NULL,
    f_entregado             DATE DEFAULT NULL,
    f_arribo_est            DATE DEFAULT NULL,
    f_arribo_nec            DATE DEFAULT NULL,
